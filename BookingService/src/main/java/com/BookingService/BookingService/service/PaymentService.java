...
public class PaymentService {
    ...
    private static final String MERCHANT_ID = "1233436";      // SANDBOX
    private static final String MERCHANT_SECRET = "MjIyNDY5NzY4NTIyMjc2NDczMTcyODMwMDY0NjgyMzU2MzQ5NzM2"; // SANDBOX SECRET
